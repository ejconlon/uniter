...
-- | A polytype
type PolyTy g = ForAll TyBinder (BoundTy g Index)

monoToPolyTy :: (Recursive u, Base u ~ g) => u -> PolyTy g
monoToPolyTy = ForAll Seq.empty . monoToBoundTy
...
newtype SpecTm (h :: Type -> Type -> Type) (g :: Type -> Type) (a :: Type) (i :: Type) = SpecTm {unSpecTm :: SpecTmF h g a i (SpecTm h g a i)}
...
type SpecFinal h g = ForAll TyBinder (SpecTm h g (PolyTy g) (BoundTy g Index))
